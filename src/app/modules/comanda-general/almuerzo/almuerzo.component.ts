...
export class AlmuerzoComponent {
  displayedColumns: string[] = [
    'ubicacion', 'diagnostico', 'nombre', 'apellido', 'alergias',
    'dietaIndicada', 'dietaAdecuada', 'entrada', 'platoPrincipal',
    'guarnicion', 'postre', 'bebida', 'panificados', 'otroEspeciales',
    'gustosSi', 'gustosNo', 'anamnesis', 'editar', 'validar'
  ];
